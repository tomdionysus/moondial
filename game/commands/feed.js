...
module.exports = class PatCommand extends Command {
	...
	execute() {
		if (this.actor.isPlayer()) {
			this.actor.narrative('feed '+this.thing.id)
		} else {
			this.actor.narrative('feeds '+this.thing.id)
		}
	}

	static help(gameEngine, actor) {
		if(!actor.isPlayer()) return
		gameEngine.writeLine('help: feed <thing> - feeds the selected thing')
	}
